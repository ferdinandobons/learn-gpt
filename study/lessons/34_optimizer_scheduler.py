...
- This lesson script uses the English project layout and imports lesson-specific
  snapshot code.
- It belongs to lesson 34 of the guided LearnGPT path.
...
CHECKPOINT_PATH = Path(tempfile.gettempdir()) / "learngpt_lesson_34" / "best_checkpoint.pt"

sys.path.append(str(PROJECT_DIR))

from study.snapshots.lesson_34.generate import generate_text_from_checkpoint
from study.snapshots.lesson_34.model import LanguageModel
from study.snapshots.lesson_34.tokenizer import create_vocabulary, encode
from study.snapshots.lesson_34.training import configure_optimizer, train_model

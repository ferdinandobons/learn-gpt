...
- This lesson script uses the English project layout and imports lesson-specific
  snapshot code.
- It belongs to lesson 16 of the guided LearnGPT path.
...
def show_prediction(model, prompt, char_to_id, id_to_char):
    ...
    print("Last character:", repr(prompt[-1]))
    print("Predicted token with maximum score:", repr(decode([predicted_token_id], id_to_char)))
    print()

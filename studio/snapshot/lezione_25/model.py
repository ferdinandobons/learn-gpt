...
- Qui manteniamo solo i componenti necessari a un singolo TransformerBlock.
- `LanguageModel` indica il modello della lezione corrente.

Scopo del file:
- Raggruppare attention, MLP, LayerNorm e residual connections in `TransformerBlock`.
- Usare un solo blocco prima di `output_head`.
"""

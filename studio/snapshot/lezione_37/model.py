...
- La struttura del modello resta quella della lezione 35.
- Qui la usiamo come versione consolidata per il progetto finale.
...
- Essere copiabile dentro `progetto_finale/model.py`.
"""

...
- Il modello resta uguale alla lezione 28.
- La novità della lezione 29 non è dentro `model.py`, ma nel nuovo modulo
  `training.py`, che stima training loss e validation loss.

Scopo del file:
- Fornire il `LanguageModel` Transformer usato dalla lezione 29.

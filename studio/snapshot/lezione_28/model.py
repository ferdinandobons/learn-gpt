...
- Il modello resta uguale alla lezione 27.
- La novità della lezione 28 non è dentro `model.py`, ma nello script di
  training che aggiorna i pesi del modello.

Scopo del file:
- Fornire il `LanguageModel` Transformer usato dal training della lezione 28.

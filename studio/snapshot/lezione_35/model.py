...
- Prima il Transformer non usava dropout e la tabella degli embedding di input
  era separata dalla testa di output.
- Qui aggiungiamo dropout e weight tying opzionale.

Scopo del file:
- Regolarizzare il modello durante il training.
- Ridurre il numero di parametri collegando input embeddings e output head.
- Avvicinare il modello didattico alla struttura usata da nanoGPT.
"""
...
class SelfAttentionHead(nn.Module):
    def __init__(self, embedding_size, head_size, context_size, dropout):
        super().__init__()
...
class MultiHeadAttention(nn.Module):
    def __init__(self, embedding_size, head_size, context_size, num_heads, dropout):
        super().__init__()

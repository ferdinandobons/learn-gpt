...
- Prima `generate` campionava sempre dalla distribuzione completa.
- Qui aggiungiamo `temperature` e `top_k` alla generazione.

Scopo del file:
- Fornire il `LanguageModel` Transformer usato dalla lezione 34.
- Calcolare logits e loss quando riceve input e target.
- Controllare il campionamento del token successivo.
"""

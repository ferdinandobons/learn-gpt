...
- Qui manteniamo solo i componenti necessari a LayerNorm prima della attention.
- `LanguageModel` indica il modello della lezione corrente.

Scopo del file:
- Normalizzare gli embeddings prima della multi-head attention.
- Mantenere la residual connection dopo la attention.
"""

...
- Qui manteniamo solo i componenti necessari a più TransformerBlock in sequenza.
- `LanguageModel` indica il modello della lezione corrente.

Scopo del file:
- Conservare più blocchi in `nn.ModuleList`.
- Applicare i blocchi uno dopo l'altro prima di `output_head`.
"""

...
- Qui manteniamo solo i componenti necessari alla residual connection attorno alla attention.
- `LanguageModel` indica il modello della lezione corrente.

Scopo del file:
- Sommare embeddings e output della attention.
- Produrre logits dopo la residual connection.
"""

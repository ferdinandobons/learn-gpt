...
- Qui manteniamo solo i componenti necessari alla multi-head attention con proiezione finale.
- `LanguageModel` indica il modello della lezione corrente.

Scopo del file:
- Usare `output_projection` dentro la multi-head attention.
- Separare `output_projection` da `output_head`.
"""

...
- Il modello resta uguale alla lezione 30.
- La novità della lezione 31 non è dentro `model.py`, ma nel nuovo modulo
  `generate.py`, che genera testo da un checkpoint.

Scopo del file:
- Fornire il `LanguageModel` Transformer usato dalla lezione 31.

...
- Prima `training.py` stimava solo la loss media.
- Qui aggiungiamo `train_model`, una funzione riutilizzabile che addestra il
  modello, valuta periodicamente la loss e salva il checkpoint migliore.

Scopo del file:
- Separare il ciclo di training dagli script di studio.
- Salvare il modello solo quando la validation loss migliora.
- Restituire una storia leggibile delle valutazioni fatte durante il training.
"""

...
- Qui rimuoviamo il modello bigram dallo snapshot.
- `LanguageModel` ora indica il modello con token embeddings.

Scopo del file:
- Separare token embeddings e testa di output.
- Calcolare logits e loss partendo dagli embeddings dei token.
"""

...
- Il modello resta uguale alla lezione 29.
- La novità della lezione 30 non è dentro `model.py`, ma nel nuovo modulo
  `checkpoint.py`, che salva e ricarica lo stato del training.

Scopo del file:
- Fornire il `LanguageModel` Transformer usato dalla lezione 30.
- Calcolare logits e loss quando riceve input e target.
"""

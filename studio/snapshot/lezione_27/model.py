...
- Qui manteniamo solo i componenti necessari al modello con LayerNorm finale.
- `LanguageModel` indica il modello della lezione corrente.

Scopo del file:
- Applicare più TransformerBlock in sequenza.
- Normalizzare l'output finale dei blocchi prima di `output_head`.
"""

...
- L'optimizer ora separa i parametri con e senza weight decay.
- Il training loop supporta gradient accumulation, resume da checkpoint e
...
- Rendere il training più vicino allo stile di nanoGPT, ma ancora leggibile.
"""
...
def maybe_compile_model(model, compile_model):
    ...
    if not hasattr(torch, "compile"):
        raise RuntimeError("torch.compile non è disponibile in questa versione di PyTorch.")

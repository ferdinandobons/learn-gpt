...
- Qui manteniamo solo attention, feed-forward e il modello che li usa.
- `LanguageModel` indica il modello della lezione corrente.

Scopo del file:
- Aggiungere la MLP dopo la attention.
- Usare una seconda residual connection dopo il feed-forward.
"""
